...
tokenizer.save_pretrained("output/bge-large-en-v1.5")
model.save_pretrained("output/bge-large-en-v1.5")
...
index.add(vectors)
write_index(index, "output/bge-large-en-v1.5/faiss.index")
